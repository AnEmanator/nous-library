...
class Me {
    constructor(dispatch, mods) {
        ...
        // channelType per continent/zone id, queried once and cached rather than
        // a hardcoded zone-id list - keeps working if a server's zone layout
        // differs instead of silently going stale
        ...
        // called, S_PLAYER_STAT_UPDATE's own "stamina" field, not "condition")
